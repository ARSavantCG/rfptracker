...
- July 8, 2025. Fixed critical evaluation budget report calculation error - corrected PDF generation to properly include rolled-up Design costs ($86,590) in Tenant Improvements total, updated calculateDisplayedCategoryTotal and calculateDisplayedCategoryTotalForPreview functions to use rollup-aware calculations instead of simple category totals, ensuring accurate financial reporting with Design costs properly distributed into TI category as configured by user rollup settings
