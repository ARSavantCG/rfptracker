...
export function CreateRfpModal({ isOpen, onClose }: CreateRfpModalProps) {
  ...
  // Watch form values to auto-generate project name in real-time
    ...
    if (property && properties.length > 0) {
      ...
      if (selectedProperty) {
        ...
        if (confidential) {
          ...
          autoGeneratedName = `${tenantName.trim()} @ ${propertyDisplay}`;
        } else {
  ...
  }, [watchedValues.property, watchedValues.tenantName, watchedValues.confidential, properties, form]);
