...
export function PropertyFormModal({ property, trigger, onSuccess }: PropertyFormModalProps) {
  ...
  const [formData, setFormData] = useState<Partial<InsertProperty>>({
    ...
    electricalAllocationMinimum: property?.electricalAllocationMinimum ?? 200,
  ...
  const resetForm = () => {
    setFormData({
      ...
      electricalAllocationMinimum: 200,
      isLandLease: false,
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const propertyData: InsertProperty = {
      ...
      electricalAllocationMinimum: formData.electricalAllocationMinimum ?? 200,
