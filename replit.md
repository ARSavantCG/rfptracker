...
- **Advanced Systems**:
    ...
    - **Alternate Display Enhancement**: Enhanced RFP table display (8/19/2025) to clearly show alternate titles in both tenant and property columns. Alternates now display the tenant name plus alternate title in purple italic text, making it easy to distinguish alternates from parent RFPs at a glance. Added "Alternate: [Title]" labels in property column for additional clarity.
