...
- July 1, 2025. Fixed critical bay double-booking prevention system - resolved React Query endpoint configuration issue that prevented executed leases from loading properly in bay selection modals, corrected query key format from array to proper URL path structure, and changed "LEASED" text to "RENTED" for better UI symmetry in bay buttons
