    ...
    return propertyImprovements
      .filter((improvement: any) => {
        ...
        if (improvement.allocationType === 'bay-specific') {
          ...
          return improvement.applicableBays?.some((bayId: any) => selectedBayIds.includes(String(bayId)) || normalizedSelectedBayIds.includes(String(bayId).replace(/_north$|_south$/i, '')));
        }
