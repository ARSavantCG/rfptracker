          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4">
            ...
            <Card>
              <CardContent className="p-4 text-center">
                <div className="flex items-center justify-center space-x-2 mb-2">
                  ...
                  <span className="text-2xl font-bold text-purple-600">{metrics.received}</span>
                </div>
            ...
            <Card>
              <CardContent className="p-4 text-center">
                <div className="flex items-center justify-center space-x-2 mb-2">
                  ...
                  <span className="text-2xl font-bold text-orange-600">{metrics.inProgress}</span>
                </div>
            ...
            <Card>
              <CardContent className="p-4 text-center">
                <div className="flex items-center justify-center space-x-2 mb-2">
                  ...
                  <span className="text-2xl font-bold text-red-600">{metrics.onHold}</span>
                </div>
            ...
            <Card>
              <CardContent className="p-4 text-center">
                <div className="flex items-center justify-center space-x-2 mb-2">
                  ...
                  <span className="text-2xl font-bold text-yellow-600">{metrics.dueSoon}</span>
                </div>
            ...
            <Card>
              <CardContent className="p-4 text-center">
                <div className="flex items-center justify-center space-x-2 mb-2">
                  <AlertTriangle className="h-5 w-5 text-red-600" />
                  <span className="text-2xl font-bold text-red-600">{metrics.overdue}</span>
                </div>
